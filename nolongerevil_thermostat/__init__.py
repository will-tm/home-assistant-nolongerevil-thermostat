"""The No Longer Evil Thermostat integration."""
...
async def async_setup(hass: HomeAssistant, config: ConfigType) -> bool:
    """Set up the No Longer Evil Thermostat component."""
    hass.data.setdefault(DOMAIN, {})
    return True


async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    """Set up No Longer Evil Thermostat from a config entry."""
...
class NoLongerEvilMQTTClient:
    """MQTT client for No Longer Evil Thermostat."""
    ...
    def get_set_topic(self, serial: str, object_type: str, field: str) -> str:
        """Get full topic path for setting values."""
