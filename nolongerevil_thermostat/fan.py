"""Fan platform for No Longer Evil Thermostat."""
...
async def async_setup_entry(
    ...
    """Set up No Longer Evil Thermostat fan entities."""
...
class NoLongerEvilFan(FanEntity):
    """Representation of a No Longer Evil Thermostat fan."""
    ...
    def _subscribe_to_topic(self) -> None:
        """Subscribe to MQTT topic for fan state."""
    ...
    def _handle_fan_state(self, topic: str, payload: str) -> None:
        ...
        try:
            ...
            _LOGGER.debug(
                "Updated fan state for %s: %s", self._serial, "on" if self._is_on else "off"
            )
    ...
    async def async_turn_on(
        ...
        **kwargs: Any,
        ...
        """Turn on the fan."""
        topic = self._mqtt_client.get_set_topic(self._serial, "device", "fan_timer_active")
